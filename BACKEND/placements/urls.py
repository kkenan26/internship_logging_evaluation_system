...
urlpatterns = [
    ...
    path('request/', views.StudentPlacementRequestView.as_view(), name='placement_request'),
    path('<int:pk>/approve/', views.AdminApprovePlacementView.as_view(), name='approve_placement'),
]